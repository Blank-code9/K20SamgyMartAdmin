				...
				<div class="account-form-inner">
					<div class="account-container">
						<div class="heading-bx left">
							<h2 class="title-head" style="border-color: #BF3C3C!important;">Create<span> New Password</span></h2>
						</div>
						<form class="contact-bx" method="POST">
							<div class="row placeani">
								...
								<div class="col-lg-12 m-b30">
									...
									<button id="myButton" class="red-hover btn btn-block" name="update">Update Password</button>
										<?php 
											if(isset($_POST['update'])){
												...
												if($pass == $pass2){
													$updatepass = password_hash($pass, PASSWORD_DEFAULT);
													$sql = "UPDATE admin SET pword = '$updatepass'";
													$conn->query($sql) or die ($conn->error);
													echo"<script>alert('update successfuly'); window.location='index.php'</script";
													
										
												}else{
													echo "<center><h5 style='color: red;'>Password is not the same</h5></center>";
												}
