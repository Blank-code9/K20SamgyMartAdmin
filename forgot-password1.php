				...
				<div class="account-form-inner">
					<div class="account-container">
						<div class="heading-bx left">
							<h2 class="title-head" style="border-color: #BF3C3C!important;">Answer <span>Security Question</span></h2>
						</div>
						<form class="contact-bx" method="POST">
							<div class="row placeani">
								<div class="col-lg-12">
									<div class="form-group">
										<label>Memorable place no one knows?</label>
									</div>
									<div class="form-group">
										<div class="input-group">
											<label>(City Only)</label>
								...
								<div class="col-lg-12 m-b30">
									<div id="submit-button">
										<button id="myButton" class="red-hover btn btn-block" name="confirm">Confirm</button>
										<?php
											if(isset($_POST['confirm'])){
												$answer = $_POST['answer'];
												
												$sql = "SELECT * FROM admin WHERE security_question = '$answer'";
