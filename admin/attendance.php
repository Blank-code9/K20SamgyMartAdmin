				...
				<div class="widget-box">
					<div class="widget-inner">
						<div class="row">
							...
							<div class="col-lg-6">
								<a href="" class="btn green radius-xl" style="background-color: #BF3C3C;float: right;"><i class="fa fa-print"></i><span>&nbsp; PRINT ATTENDANCE RECORDS</span></a>
												...
												<div class="modal-body">
													<div class="row">
														...
														<div class="form-group col-6">
															...
															<input class="form-control" name="approve-email" type="text" value="" readonly style="background-color: white;">
														</div>
														<div class="form-group col-6">
										...
										<tbody>
											...
											?>
													<tr>
														...
														<td>
															<center>
																<a href="" data-toggle="modal" data-id="<?php echo $row['EmployeeID']; ?>" data-target="#attendance" class="btn green view_data" style="width: 50px; height: 37px;" data-toggle="tooltip" title="View Summary of Attendance"><i class="fa fa-clock-o" style="font-size: 12px;"></i></a>&nbsp;
															</center>
														</td>
													</tr>
											<?php
