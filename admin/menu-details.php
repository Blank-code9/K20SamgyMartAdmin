								...
								<div class="row">
									...
									<div class="col-lg-4">
										<div class="row" style="border: 1px solid black; padding-top: 10px; margin-left: 0px;">
											...
											<div class="col-lg-6">
												<label class="col-form-label">Till ID :</label>
											</div>
											<div class="col-lg-6" style="margin-bottom: 10px;">
												<input class="form-control" type="text" required>
											</div>
										...
										<div class="row">
											...
											<div class="col-lg-5" style="margin-top: 10px;">
												<button type="button" class="btn btn-block">Sales Return</button>
											</div>
										</div>
									</div>
											...
											<table class="table hover" style="width:100%">
												<thead style="background-color: #BF3C3C;">
													<tr>
														...
														<th style="color: white;">Sales Rate</th>
														<th style="color: white;">Discount</th>
														<th style="color: white;">VAT</th>
